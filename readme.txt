========================================================================
    PROYECTO MAKEFILE: Información general de Project2
========================================================================

AppWizard ha creado este proyecto Project2. 

Este archivo contiene un resumen de lo que encontrará en todos los archivos
que constituyen el proyecto Project2.
...
Este proyecto permite compilar/limpiar/recompilar desde Visual Studio llamando a los comandos que ha introducido en el asistente. El comando de compilación puede ser nmake o cualquier otra herramienta que utilice.

Este proyecto no contiene ningún archivo, por lo que no se muestra ninguno en el Explorador de soluciones.
